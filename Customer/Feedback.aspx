<%@ Page Language="VB" MasterPageFile="~/Master/CustomerMaster.master" AutoEventWireup="false" CodeFile="Feedback.aspx.vb" Inherits="Customer_Feedback" title="Feedback" %>
...
<h2 align="center" class="heading">
    ...
    <table align="center" class="text">
        ...
        <tr>
            <td colspan="2">
                <asp:ValidationSummary ID="vsFeedback" runat="server" ValidationGroup="vgLogIn" ShowMessageBox="True" ShowSummary="False" />
            </td>
        </tr>
    </table>
</asp:Content>
