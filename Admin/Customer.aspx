<%@ Page Language="VB" MasterPageFile="~/Master/AdminMaster.master" AutoEventWireup="false"
    CodeFile="Customer.aspx.vb" Inherits="Admin_Customer" Theme="AdminTheme" %>

<asp:Content ContentPlaceHolderID="cphAdmin" runat="server" Title="Customer">
    ...
    <table align="center" class="text">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RangeValidator ID="rvPassword" runat="server" ErrorMessage="Please enter password between 4 to 20 characters."
                    ControlToValidate="txtPassword">*</asp:RangeValidator></td>
        </tr>
        <tr>
            <td>
                Confirm Password</td>
