...
Partial Class Admin_Customer
        ...
        If ViewState("ID") IsNot Nothing Then
            ...
            If dtCustomer IsNot Nothing Then
                If dtCustomer.Rows.Count > 0 Then
                    ...
                    End If
                    drCustomer.IsActive = chkIsActive.Checked
                    drCustomer.EndEdit()
    ...
    Private Sub Insert()
        ...
        If dtCustomer IsNot Nothing Then
            ...
            End If
        End If
        daCustomer.Insert(txtFirstName.Text.Trim, txtLastName.Text.Trim, txtAddress.Text.Trim, CLng(ddlCity.SelectedValue), txtPincode.Text.Trim, txtPhoneNumber.Text.Trim, txtContactNumber.Text.Trim, txtEmailId.Text.Trim, SMSCommon.TripleDESEncode(txtPassword.Text.Trim), chkIsActive.Checked)
        Response.Redirect("~/Admin/ManageCustomer.aspx")
    End Sub
        ...
        If ViewState("ID") IsNot Nothing Then
            ...
            If dtCustomer IsNot Nothing Then
                If dtCustomer.Rows.Count > 0 Then
                    ...
                    chkIsActive.Checked = drCustomer.IsActive
                End If
            End If
        End If
    End Sub
